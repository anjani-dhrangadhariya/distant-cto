...
from ReadCandidateData import fetchAndTransformCandidates
...
if __name__ == "__main__":
    ...
    for eachSeed in [ 0 ]:
        ...
        with mlflow.start_run() as run:
            ...
            # checkpoint = torch.load('/mnt/nas2/results/Results/systematicReview/distant_pico/FS/intervention/transformercrf/0_7.pth', map_location='cuda:0')
            # model.load_state_dict( checkpoint )
