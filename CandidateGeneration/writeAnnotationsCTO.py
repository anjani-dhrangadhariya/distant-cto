...
file_write_trial = '/mnt/nas2/data/systematicReview/clinical_trials_gov/Weak_PICO/intervention_data_preprocessed/' + 'extraction1_woShortIntDesc.txt'
...
for hit in res['hits']['hits']: # XXX: Only a part search results from the CTO
    ...
    try:
            ...
            if interventionName is not None:
                ...
                if interventionDescription_annot:
                    if 'interventionDescription_annot' not in write_intervention:
                        ...
                        agrregateannot_interventionDescription.append( interventionDescription_annot )
                # if len(interventionDescription_token) >= 15:               
                #     print(interventionDescription_token)
        ...
        #     # file_write = '/mnt/nas2/data/systematicReview/clinical_trials_gov/trial/' + NCT_id + 'extraction1.json'
        #     file_write = '/mnt/nas2/data/systematicReview/clinical_trials_gov/Weak_PICO/intervention/' + NCT_id + '/extraction1.json'
        #     with open(file_write, 'a+') as wf:
        #         json.dump(write_hit, wf)
        # if detailedDescription_aggdict or briefsummary_aggdict or interventionDescription_aggdict or briefTitleTarget_annot or officialTitleTarget_annot:
        # if 'aggregate_annot' in write_hit:
